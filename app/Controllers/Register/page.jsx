...
export default function Register() {
    return (
        <div className="bg-white p-5 items-center justify-center flex m-0 rounded-2xl flex-col h-[400px] shadow-lg max-w-3xl mx-auto mt-5 mb-5">
            <form className="p-5 w-full space-y-4">
                ...
                <div className="input-group">
                    ...
                    <input type="email" id="email" placeholder="กรุณากรอกอีเมล" required className="p-2 w-full focus:outline-none focus:ring-2 focus:ring-green-500 rounded-md"></input>
                </div>
                <div className="w-[30%] bg-green-600 hover:bg-green-400 hover: text-white text-center rounded-lg cursor-pointer m-auto transition duration-200">
                    <button type="submit" class="login-button" className="p-3 ">Register</button>
                </div>
            </form>
        </div>
    )
